...
public class BasketIntegrationTest {
    ...
    @Test
    void viewsItemsInBasket() {
        client.goToHomepage();
        client.clickAddToBasket("All Butter Croissant");
        client.goToBasket();

        assertThat(client.getBasketItemQtyLabel("All Butter Croissant")).isEqualTo("1");
        assertThat(client.getBasketItemQtyLabel("Red Velvet")).isEqualTo("");
    }

    @Test
    void removesItemFromBasket() {
        client.goToHomepage();
        client.clickAddToBasket("All Butter Croissant");
        client.clickAddToBasket("All Butter Croissant");
        client.goToBasket();
        client.clickRemoveFromBasket("All Butter Croissant");

        assertThat(client.getBasketItemQtyLabel("All Butter Croissant")).isEqualTo("1");

        client.clickRemoveFromBasket("All Butter Croissant");

        assertThat(client.getBasketItemQtyLabel("All Butter Croissant")).isEqualTo("");
    }
